...
RSS_FEEDS = {
    ...
    "🔥 이슈 (모든 분야)": [
        {"source": "JTBC 뉴스 (종합)", "url": "https://news.jtbc.co.kr/rss"},
        {"source": "SBS 뉴스 (종합)", "url": "https://news.sbs.co.kr/news/rss.do"},
        {"source": "연합뉴스 (주요뉴스)", "url": "http://www.yonhapnews.co.kr/RSS/headline.xml"}
    ],
    "⚖️ 정치": [
